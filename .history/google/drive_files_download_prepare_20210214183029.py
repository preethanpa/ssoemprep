...
if drive_files_list == []:
    ...
    for index, item in enumerate(drive_files_list.get('files')):
        try:
            ...
            download_drive_file(resource=get_resource(domain_wide_delegate=False), document_id=, google_file_type=google_file_type, target_type=target_file_type, target_location=location)
