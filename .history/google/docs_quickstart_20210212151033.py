...
SCOPES = ['https://www.googleapis.com/auth/drive.readonly' 'https://www.googleapis.com/auth/drive' 'https://www.googleapis.com/auth/documents.readonly']
...
def main():
    ...
    drive_credentials = ServiceAccountCredentials.from_json_keyfile_name(SERVICE_ACCOUNT_FILE, SCOPES)
