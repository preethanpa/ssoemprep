...
def main():
    ...
    SCOPES = ['https://www.googleapis.com/auth/documents', 'https://www.googleapis.com/auth/documents.', 'https://www.googleapis.com/auth/documents.readonly', 'https://www.googleapis.com/auth/sqlservice.admin', 'https://www.googleapis.com/auth/drive.file']
    ...
    docs_service = build('docs', 'v1', credentials=credentials, subject='abhi@third-ray.com')
    print(drive_service)
