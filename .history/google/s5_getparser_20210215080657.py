...
# doc_context = 'mock'
exc_context = json.loads(sys.argv[1])['context'] if sys.argv.len json.loads(sys.argv[1])['context'] is not None else None
doc_context = json.loads(sys.argv[1])['doc_name'] if json.loads(sys.argv[1])['doc_name'] is not None else None
