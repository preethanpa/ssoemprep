...
# doc_context = 'mock'
exc_context = json.loads(sys.argv[1])['context'] if json.loads(sys.argv[1])['context'] is not None else json.loads(sys.argv[1])['context']
doc_context = json.loads(sys.argv[1])['doc_name'] if json.loads(sys.argv[1])['doc_name'] is not None else json.loads(sys.argv[1])['doc_name']
