...
drive_files_list = [] if (sys.argv is None or sys.argv[1] is None or sys.argv[1].google_file_type is None) else json.loads(sys.argv[1]).files
print(drive_files_list)
