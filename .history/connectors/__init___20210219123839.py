...
from trir import settings, utils
from trir.utils import json_loads, query_is_select_no_limit, add_limit_to_query
from rq.timeouts import JobTimeoutException

from trir.utils.requests_session import requests, requests_session
...
class BaseSQLQueryRunner(BaseQueryRunner):
    ...
    def apply_auto_limit(self, query_text, should_apply_auto_limit):
        if should_apply_auto_limit:
            from trir.query_runner.databricks import split_sql_statements, combine_sql_statements
