...
# doc_context = 'shubhodeep_g_resume_2020'
exc_context = 'date_of_birth' if json.loads(sys.argv[1])['context'] is None else json.loads(sys.argv[1])['context']
# doc_context = 'Test-Document' if json.loads(sys.argv[1])['doc_name'] is None else json.loads(sys.argv[1])['doc_name']
doc_context = 'shubhodeep_g_resume_2020' if json.loads(sys.argv[1])['doc_name'] is None else json.loads(sys.argv[1])['doc_name']
