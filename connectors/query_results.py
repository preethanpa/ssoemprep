...
from trir import models
from trir.permissions import has_access, view_only
...
def _load_query(user, query_id):
    ...
    # TODO: this duplicates some of the logic we already have in the trir.handlers.query_results.
