...
part_index = json.loads(sys.argv[1])['part_index']
...
json_out = {"pdf_doc": pdf_doc, "process_status": proc_status, "original_pdf_path": original_pdf_path, "original_html_path": original_html_path, "job_id": job_id, "part_index": part_index}
