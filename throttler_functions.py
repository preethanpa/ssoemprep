...
def tf_byname(cname):
    ...
    def data_subject_name_all_over_the_place(c):
        (data_subject_name) = c
        if same_sentence((data_subject_name)):
            return True
        return False
    ...
    def permanent_account_number_match_filter_same_sentence(c):
    ...
    def permanent_account_number_match_filter(c):
        (permanent_account_number_match_filter) = c
        if permanent_account_number_match_filter_same_sentence and True:
            return True
    ...
    throttler_function_strings = {
        ...
        'permanent_account_number_match_filter': permanent_account_number_match_filter,
        ...
        'data_subject_name_all_over_the_place': data_subject_name_all_over_the_place
    }
